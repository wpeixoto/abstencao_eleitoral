...
d. Utilizando a função **hist()** (consulte ?hist), plote o histograma das idades (1) considerando todos os respondentes e (2) considerando apenas os respondentes do estado 94. Alguma das distribuições parece ser normal? Comente. `r pend`
...
b. Construa tabelas de frequência que ilustrem os seguintes cruzamentos de variáveis, considerando os estados 21, 44, 58, 82 e 94:
    ...
    3. tipo do emprego perdido (joblost): dados absolutos, relativos e acumulados `r pend`
    4. casado (married): dados absolutos, relativos e acumulados `r pend`
...
f. A partir do conjunto de dados **votZona** resultante, informe a quantidade de municípios em SC onde ocorreram as eleições de 2016 e a quantidade de zonas eleitorais. `r pend`
