...
Nesta página, as comparações dois a dois serão feitas segundo esse critério.
...
for (i in 2:length(elet)) {
  ...
  dnormC(el_1, el_2, paste0("Taxas de abstenção: ", ANO1, "/", TURNO1, "º Turno x ", ANO2, "/", TURNO2, "º Turno"))
}
```